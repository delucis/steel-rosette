...
, 			{
				"box" : 				{
					"comment" : "internal dictionary reloaded/changed",
					"id" : "obj-3",
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "bang", "", "cues" ],
					"patching_rect" : [ 15.0, 75.0, 199.0, 20.0 ],
					"text" : "t b getkeys cues"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 105.0, 195.0, 109.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 195.0, 165.0, 67.0, 20.0 ],
					"text" : "route cues"
				}
...
, 			{
				"box" : 				{
					"args" : [ "srb._getcuelist", "get list of cue numbers from srb._dict" ],
					"id" : "obj-1",
					"maxclass" : "bpatcher",
...
, 			{
				"box" : 				{
					"comment" : "list of cue numbers (int int int…)",
					"id" : "obj-56",
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 45.0, 169.0, 20.0 ],
					"text" : "get list of cue numbers (bang)"
				}

			}
, 			{
				"box" : 				{
					"comment" : "get list of cue numbers (bang)",
					"id" : "obj-52",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,

...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 270.0, 45.0, 72.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 165.0, 93.0, 22.0 ],
					"text" : "send srb.hooks"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 135.0, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 225.0, 90.0, 30.0, 30.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 15.0, 90.0, 195.0, 30.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 195.0, 30.0 ],
					"rounded" : 16.0,
...
, 			{
				"box" : 				{
					"args" : [ "srb.shortcuts", "GUI for keyboard shortcuts" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 45.0, 197.0, 20.0 ],
					"text" : "turn keyboard shortcuts on/off (1/0)"
				}

			}
, 			{
				"box" : 				{
					"comment" : "turn keyboard shortcuts on/off (1/0)",
					"id" : "obj-52",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "srb._modulebar.maxpat",
				"bootpath" : "~/Documents/Max 8/Packages/clara-duo/patchers/stdlib",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}

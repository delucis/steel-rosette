...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 210.0, 150.0, 30.0, 30.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 75.0, 135.0, 24.0, 20.0 ],
									"text" : "t 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 15.0, 165.0, 79.0, 20.0 ],
									"text" : "gate 1 1"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 75.0, 75.0, 63.0, 20.0 ],
									"text" : "dspstate~"
								}
...
,
					"patching_rect" : [ 105.0, 150.0, 95.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 15.0, 90.0, 93.0, 22.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "srb.adstatus", "big button to report/switch audio status" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 45.0, 153.0, 20.0 ],
					"text" : "turn audio DSP on/off (1/0)"
				}

			}
, 			{
				"box" : 				{
					"comment" : "turn audio DSP on/off (1/0)",
					"id" : "obj-52",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
		...
		"lines" : [ 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 24.5, 242.0, 252.5, 242.0, 252.5, 80.0, 24.5, 80.0 ],
					"source" : [ "obj-102", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 24.5, 145.5, 219.5, 145.5 ],
					"order" : 0,
					"source" : [ "obj-4", 0 ]
				}
